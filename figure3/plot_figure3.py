...
os.chdir(r'C:\Users\User\Documents\08_publications\20210220_ijms\analysis\protein_lipid_assays\bLG')
figuredir = r'C:\Users\User\Documents\08_publications\20210220_ijms\figure3'
...
plt.savefig(os.path.join(figuredir, 'figure3.pdf'))
plt.show()
...
plt.savefig(os.path.join(figuredir, 'figure3B.pdf'))
plt.show()
...
plt.savefig(os.path.join(figuredir, 'figure3C.pdf'))
plt.show()
...
plt.savefig(os.path.join(figuredir, 'figure3D.pdf'))
plt.show()
...
plt.savefig(os.path.join(figuredir, 'figure3E.pdf'))
plt.show()